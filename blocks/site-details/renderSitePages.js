      ...
      tableRow.innerHTML = `
        ...
        <td>
          <div id="email-open-edit" class="button-container">
            ...
            <a class="button action secondary open" href="/redirect?url=${EMAIL_WORKER_API}/preview?contentPath=${projectDetails.customPreviewUrl}${item.path}" target="_blank">Open</a>
